      ...
      <section className="services-cta">
        <div className="container">
          <div className="cta-card">
            ...
            <p>We handle custom jobs too. Request for a service describing what you need and we'll match you with the right verified artisan near you.</p>
            <Link to="/post-job"><Button variant="secondary" size="lg" rightIcon={<ArrowRight size={18} />}>Request for a Service</Button></Link>
          </div>
        </div>
      </section>
