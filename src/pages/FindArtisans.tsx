    ...
    <div className="find-artisans">
      <div className="fa-hero">
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="fa-hero-inner">
          ...
          <p>See trusted professionals across Lagos. Ready to hire? Post a job and we'll match you with the right one.</p>
          <div className="fa-bar">
            ...
            <Link to="/post-job" className="fa-post-cta">
              <Button variant="primary" leftIcon={<ClipboardList size={18} />}>Post a job</Button>
            </Link>
          </div>
        </motion.div>
      </div>
      ...
      <div className="fa-results">
        {loading ? (
          ...
          <div className="fa-empty">
            ...
            <p>Try another area or service. You can still post a job — we'll match you as artisans come on board.</p>
            <Link to="/post-job"><Button variant="primary" leftIcon={<ClipboardList size={16} />}>Post a job</Button></Link>
          </div>
        ) : (
          <>
