            ...
            {isLoading ? (
              ...
              <>
                ...
                <section className="profile-section">
                  ...
                  <div className="quick-grid">
                    <Link to="/post-job" className="quick-card"><ClipboardList size={22} /><span>Request for Service</span></Link>
              ...
              <>
                ...
                <section className="profile-section">
                  ...
                  {jobs.length === 0 ? (
                    <div className="empty-bookings"><ClipboardList size={40} className="empty-icon" /><p>No jobs yet.</p><Link to="/post-job"><Button variant="outline" size="sm">Request for Service</Button></Link></div>
                  ) : (
